...
void main() {
  test('auth response maps into application session', () {
    ...
    final session = mapper.sessionFromJson({
      'accessToken': 'access',
  ...
  test('error item update maps into trimmed API request', () {
    ...
    expect(mapper.updateRequest(update), {
      'questionText': '1 + 1',
      'answer': '2',
      'analysis': '加法',
      'masteryLevel': 3,
  ...
  test('practice and stats payloads map without leaking JSON into domain', () {
    ...
    final question = practiceMapper.questionFromJson({
      'questionText': '题目',
      'answer': '答案',
      'analysis': '解析',
      'subjectName': '数学',
    ...
    final stats = statsMapper.overviewFromJson({
      'totalErrors': '12',
      'masteredCount': 7,
      'masteryRate': 0.58,
      'practiceTotal': 20,
