...
- [x] `PROTOCOL-010` 实现 AES-256-GCM 帧编码、AAD、sequence 和 2 MiB 上限。验证：篡改、重放、乱序、重复 nonce 测试。
- [x] `PROTOCOL-011` 实现 Manifest、FileEntry、记录流和 SHA-256 校验。验证：缺文件和 hash 错误测试。
