...
- [ ] [`:app`](./app.md) - 根工程、App 外壳和导航（APP-001/002 完成）
...
- [ ] [`:data`](./data.md) - Repository 实现和基础设施协调

批次完成标准：

- [ ] 全部 Domain Repository 有可注入实现。
- [ ] Room、AI、Keystore 和清除范围集成测试通过。

## 第 6 批：纯本地用户功能

- [ ] [`:feature:home`](./feature-home.md) - 首页
- [ ] [`:feature:library`](./feature-library.md) - 题集与错题
- [ ] [`:feature:tags`](./feature-tags.md) - 标签
- [ ] [`:feature:stats`](./feature-stats.md) - 统计
