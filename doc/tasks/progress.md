...
- [x] [`:feature:capture`](./feature-capture.md) - 拍照、分析和保存
- [x] [`:feature:tutor`](./feature-tutor.md) - 辅导、练习和批改

批次完成标准：

- [x] AI 配置缺失后可完成配置并恢复 Capture/Tutor 原操作。
- [x] 拍照和相册链路、流式停止、四档练习和三态批改通过。
- [x] 清除学习数据与恢复出厂设置的保留范围正确。

## 第 8 批：设备协议与运行时

- [x] [`:transfer:protocol`](./transfer-protocol.md) - Protobuf、SRP、加密和状态机
- [ ] [`:transfer:runtime`](./transfer-runtime.md) - NSD、TCP、续传和原子导入
- [x] [`:feature:devices`](./feature-devices.md) - 设备与迁移 UI
